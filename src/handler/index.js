          ...
          `)
               ...
               case prf + 'author':
                   const vcscardd1 = 'BEGIN:VCARD\n' // metadata of the contact card
                         ...
                         settings.Owner.replace(/@s.whatsapp.net/, '') + '\n' // WhatsApp ID + phone number
                         + 'END:VCARD'
                    conn.sendMessage(from, { displayname: 'Owner bot', vcard: vcscardd1 }, MessageType.contact, { quoted: hurtz })
