          ...
          if (user1.includes(sender)) {
               ...
               if (type == 'conversation') {
                    ...
                    if (mediaData.message.stickerMessage.contextInfo) {
                         ...
                         conn.sendMessage(targetChat, buff, MessageType.sticker, { quoted: { message: mediaData.message.stickerMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    const buff = await conn.downloadMediaMessage(mediaData)
                    ...
                    if (mediaData.message.imageMessage.contextInfo) {
                         const buff = await conn.downloadMediaMessage(mediaData)
                         conn.sendMessage(targetChat, buff, MessageType.image, { caption: body ? body : '', quoted: { message: mediaData.message.imageMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    const buff = await conn.downloadMediaMessage(mediaData)
                    ...
                    if (mediaData.message.audioMessage.contextInfo) {
                         const buff = await conn.downloadMediaMessage(mediaData)
                         conn.sendMessage(targetChat, buff, MessageType.audio, { quoted: { message: mediaData.message.audioMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    const buff = await conn.downloadMediaMessage(mediaData)
                    ...
                    if (mediaData.message.videoMessage.contextInfo) {
                         const buff = await conn.downloadMediaMessage(mediaData)
                         conn.sendMessage(targetChat, buff, MessageType.video, { caption: body ? body : '', quoted: { message: mediaData.message.videoMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    const buff = await conn.downloadMediaMessage(mediaData)
                    ...
                    if (mediaData.message.contactMessage.contextInfo) {
                         conn.sendMessage(targetChat, mediaData.message.contactMessage, 'contactMessage', { quoted: { message: mediaData.message.contactMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    ...
                    if (mediaData.message.locationMessage.contextInfo) {
                         conn.sendMessage(targetChat, mediaData.message.locationMessage, 'locationMessage', { quoted: { message: mediaData.message.locationMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    ...
                    if (mediaData.message.liveLocationMessage.contextInfo) {
                         conn.sendMessage(targetChat, mediaData.message.liveLocationMessage, 'liveLocationMessage', { quoted: { message: mediaData.message.liveLocationMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    ...
                    if (mediaData.message.documentMessage.contextInfo) {
                         const buff = await conn.downloadMediaMessage(mediaData)
                         conn.sendMessage(targetChat, buff, 'documentMessage', { mimetype: mediaData.message.documentMessage.mimetype, filename: mediaData.message.documentMessage.title, quoted: { message: mediaData.message.documentMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    const buff = await conn.downloadMediaMessage(mediaData)
                    ...
                    if (mediaData.message.stickerMessage.contextInfo) {
                         conn.sendMessage(targetChat, mediaData.message.productMessage, 'productMessage', { quoted: { message: mediaData.message.productMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    ...
                    if (mediaData.message.contactsArrayMessage.contextInfo) {
                         conn.sendMessage(targetChat, mediaData.message.contactsArrayMessage, 'contactsArrayMessage', { quoted: { message: mediaData.message.contactsArrayMessage.contextInfo.quotedMessage, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
                         return
                    }
                    ...
                    conn.sendMessage(targetChat, body, MessageType.text, { quoted: { ...quoted, key: { fromMe: true, credit: 'AnonChat By AMPIBI' } } })
               }
